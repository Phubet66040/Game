...
public class PowerIncreasePanel extends JPanel {
    ...
    public PowerIncreasePanel(JFrame frame, int currentPower, int currentResources, int agi, InitGameUI gameUI) {
        ...
        increasePowerArea = new Rectangle(470, 370, 100, 300); 
        increaseResourceArea = new Rectangle(700, 370, 100, 300); 
        backButtonArea = new Rectangle(0, 0, 350, 2000); 
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.drawString("Power+10 (-"+ren+" R)", increasePowerArea.x-70, increasePowerArea.y - 30);
        ...
        g2d.setColor(Color.WHITE);
        g2d.drawString("Resource+1 (-"+count+" P)", increaseResourceArea.x - 40, increaseResourceArea.y - 30);
